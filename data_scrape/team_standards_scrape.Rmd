...
url_reads <- function(x) {
  ...
  result <- result[[1]] %>%
    ...
    #casting all columns to be characters.  Had merging frames issue where column types did not agree, character is best way to preserve integrity and easily revertible in later cleaning steps - Aaron 10/22
